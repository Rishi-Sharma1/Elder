      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.list}>
          {ngos.length > 0 ? (
            ...
            <Text style={{ color: kineticColors.mutedForeground, textAlign: 'center', marginTop: 20 }}>No FAQs/NGOs found.</Text>
          )}
        </View>
      </ScrollView>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  info: { flex: 1, gap: 4 },
  name: { fontSize: 16, fontWeight: "bold", color: kineticColors.foreground },
  address: { fontSize: 13, color: kineticColors.mutedForeground },
  phone: { fontSize: 13, color: kineticColors.foreground },
  joinBtn: {
    backgroundColor: kineticColors.accent, paddingVertical: 8, paddingHorizontal: 16, borderRadius: 8
  },
